...
#define NODE_MAIN_LOGGER_NAME "tour_guide_start"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libtour_guide.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<robot_tour::WaypointFollowerClient>";
